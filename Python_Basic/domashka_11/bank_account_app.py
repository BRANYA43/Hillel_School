...
class BankAccount:
    ...
    def __init__(self, name: str):
        """Ініціалізує ім'я, ід, рахунок та список транзакцій."""
        self._name = name
        self._id = uuid1()
    ...
    def calculate_balance(self, transaction):
        ...
        При поповненні рахунку комісія знімається з коштів що додаються до рахунку.
        При виведенні коштів комісія знімається с рахунку користувача.
        """
        operations = {
    ...
    def deposit(self, amount: str):
        """Поповнює кошти на рахунок створюючи об'єкт транзакцій та зберігає у список транзакці зі статусом Settled."""
    ...
    def withdrawal(self, amount: str):
        """Виводить кошти з рахунку створюючи об'єкт транзакцій та зберігає у список транзакцій зі статусом Settled.
        Також перевіряє чи можливо зняти гроші, якщо ні, то додає цю транзакцію у список зі статусом Failed.
        """
        if self._balance - Decimal(amount) * (Decimal(Transaction.COMMISION) + Decimal('1')) < 0:
